...
public class Endereco implements Serializable {
    ...
    public Endereco(Integer idEndereco, String logradouro, String bairro, String cidade, String estado, String cep, float longitude, float latitude) {
        this.idEndereco = idEndereco;
    ...
    public String toString() {
        return "com.modelo.Endereco[ idEndereco=" + idEndereco + " ]";
    }
